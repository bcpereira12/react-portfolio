...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://biancapereira.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  //this another thing that can be refactored because we used it in portfolio-form
  //helper method?
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://biancapereira.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch"
      });
    }
  }
  ...
  handleChange(event) {
    //updating everytime form element changes
    this.setState({
      ...
      <form onSubmit={this.handleSubmit} className="blog-form-wrapper">
        ...
        <div className="image-uploaders">
          {this.props.editMode && this.props.blog.featured_image_url ? (
            //refactor classname below since we used it here and
            //in portfolio-form
